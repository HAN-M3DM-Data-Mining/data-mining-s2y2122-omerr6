...
#Line 41
CO2 is missing from the formula.

#Line 46
The last number is weird to clean because location 10 doesnt exist. It should be 6.

#Line 53,54,55
You are missing the $ between DF and occupany. This will give an error and wont work without the $.

#Line 84
TestDF_Labels should be 1 instead of 0. Because it has value but it isnt in a positive location.